...
class Time {
	 ...
	 *
	 *     Time::days(4, 2010); // 1, 2, 3, ..., 28, 29, 30
	 *
	...
	public static function span($remote, $local = NULL, $output = 'years,months,weeks,days,hours,minutes,seconds')
	{
		...
		{
			$timespan -= Time::YEAR * ($output['years'] = (int) floor($timespan / Time::YEAR));
		}

		if (isset($output['months']))
		{
			$timespan -= Time::MONTH * ($output['months'] = (int) floor($timespan / Time::MONTH));
		}

		if (isset($output['weeks']))
		{
			$timespan -= Time::WEEK * ($output['weeks'] = (int) floor($timespan / Time::WEEK));
		}

		if (isset($output['days']))
		{
			$timespan -= Time::DAY * ($output['days'] = (int) floor($timespan / Time::DAY));
		}

		if (isset($output['hours']))
		{
			$timespan -= Time::HOUR * ($output['hours'] = (int) floor($timespan / Time::HOUR));
		}

		if (isset($output['minutes']))
		{
			$timespan -= Time::MINUTE * ($output['minutes'] = (int) floor($timespan / Time::MINUTE));
		}
	 ...
	 * Note that unlike [Time::span], the "local" timestamp will always be the
	...
	public static function fuzzy_span($timestamp)
	{
		...
		elseif ($offset < (Time::MINUTE * 20))
		{
			$span = 'a few minutes';
		}
		elseif ($offset < Time::HOUR)
		{
			$span = 'less than an hour';
		}
		elseif ($offset < (Time::HOUR * 4))
		{
			$span = 'a couple of hours';
		}
		elseif ($offset < Time::DAY)
		{
			$span = 'less than a day';
		}
		elseif ($offset < (Time::DAY * 2))
		{
			$span = 'about a day';
		}
		elseif ($offset < (Time::DAY * 4))
		{
			$span = 'a couple of days';
		}
		elseif ($offset < Time::WEEK)
		{
			$span = 'less than a week';
		}
		elseif ($offset < (Time::WEEK * 2))
		{
			$span = 'about a week';
		}
		elseif ($offset < Time::MONTH)
		{
			$span = 'less than a month';
		}
		elseif ($offset < (Time::MONTH * 2))
		{
			$span = 'about a month';
		}
		elseif ($offset < (Time::MONTH * 4))
		{
			$span = 'a couple of months';
		}
		elseif ($offset < Time::YEAR)
		{
			$span = 'less than a year';
		}
		elseif ($offset < (Time::YEAR * 2))
		{
			$span = 'about a year';
		}
		elseif ($offset < (Time::YEAR * 4))
		{
			$span = 'a couple of years';
		}
		elseif ($offset < (Time::YEAR * 8))
		{
			$span = 'a few years';
		}
		elseif ($offset < (Time::YEAR * 12))
		{
			$span = 'about a decade';
		}
		elseif ($offset < (Time::YEAR * 24))
		{
			$span = 'a couple of decades';
		}
		elseif ($offset < (Time::YEAR * 64))
		{
